...
<div class="page-heading"><div><p class="eyebrow">DAILY OVERVIEW</p><h1>Dashboard</h1><p>Sales, vouchers and connections in one place.</p></div><a href="/sell" class="button"><Icon name="plus" size={18}/> Sell internet</a></div>
...
<div class="chart-grid">
 <section class="panel chart-card revenue-report">
  <header class="card-head"><div><h2>Revenue report</h2><p class="small muted">Last 30 days, after reversals</p></div><a class="small-button" href="/reports">Reports <Icon name="arrow" size={14}/></a></header>
